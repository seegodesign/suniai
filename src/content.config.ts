...
const home = defineCollection({
  ...
  schema: z.object({
    ...
    heroCta1Label: z.string().optional().default(''),
    heroCta1Href: z.string().optional().default(''),
    heroCta2Label: z.string().optional().default(''),
    heroCta2Href: z.string().optional().default(''),
    aboutHeading: z.string().optional().default(''),
    aboutBodies: z.array(z.string()).optional().default([]),
    servicesHeading: z.string().optional().default(''),
